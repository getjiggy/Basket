...
import { Address } from "OpenZeppelin/openzeppelin-contracts@4.3.2/contracts/utils/Address.sol";
...
contract BasketToken is ERC20, VRFConsumerBase {
    ...
    constructor(
        ...
        address _link
        ) ERC20(_name, _symbol) VRFConsumerBase(_vrf_coordinator, _link) {
    ...
    function ImFeelingLucky() public {
        ...
        getRandomNumber();
        uint[] memory res = expand(randomResult, 2);
